 ...
 */ const useStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".f12nh0o2{-ms-grid-columns:[content] 1fr [icon] auto [end];grid-template-columns:[content] 1fr [icon] auto [end];}",
...
const useIconStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".f12w6cgp{-ms-grid-column:icon;grid-column-start:icon;}",
        ".f8bv1bt{-ms-grid-column-span:end;grid-column-end:end;}",
