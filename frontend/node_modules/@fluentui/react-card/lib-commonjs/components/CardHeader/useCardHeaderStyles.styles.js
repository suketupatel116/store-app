...
const useStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".f8a668j{-ms-grid-auto-columns:min-content 1fr min-content;grid-auto-columns:min-content 1fr min-content;}",
        ".f4h39za{-ms-grid-auto-rows:1fr min-content;grid-auto-rows:1fr min-content;}",
        ...
        ".fldnz9j{-ms-grid-row:span 2;grid-row-start:span 2;}",
