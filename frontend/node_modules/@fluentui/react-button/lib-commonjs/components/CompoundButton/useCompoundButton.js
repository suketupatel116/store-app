...
Object.defineProperty(exports, "useCompoundButton_unstable", {
    enumerable: true,
    get: ()=>useCompoundButton_unstable
});
...
const useCompoundButton_unstable = ({ contentContainer , secondaryContent , ...props }, ref)=>{
    ...
    const state = {
        ...
        contentContainer: (0, _reactUtilities.resolveShorthand)(contentContainer, {
            required: true
        }),
        secondaryContent: (0, _reactUtilities.resolveShorthand)(secondaryContent)
    };
