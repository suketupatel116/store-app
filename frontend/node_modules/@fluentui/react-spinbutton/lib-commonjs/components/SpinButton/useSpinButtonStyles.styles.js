...
const useRootClassName = /*#__PURE__*/ (0, _react["__resetStyles"])("rkqmps4", "r1trw52p", [
    ".rkqmps4{display:-ms-inline-grid;display:inline-grid;-ms-grid-columns:1fr 24px;grid-template-columns:1fr 24px;-ms-grid-rows:1fr 1fr;grid-template-rows:1fr 1fr;-webkit-column-gap:var(--spacingHorizontalXS);column-gap:var(--spacingHorizontalXS);row-gap:0;position:relative;isolation:isolate;background-color:var(--colorNeutralBackground1);min-height:32px;padding:0 0 0 var(--spacingHorizontalMNudge);border-radius:var(--borderRadiusMedium);}",
    ...
    ".r1trw52p{display:-ms-inline-grid;display:inline-grid;-ms-grid-columns:1fr 24px;grid-template-columns:1fr 24px;-ms-grid-rows:1fr 1fr;grid-template-rows:1fr 1fr;-webkit-column-gap:var(--spacingHorizontalXS);column-gap:var(--spacingHorizontalXS);row-gap:0;position:relative;isolation:isolate;background-color:var(--colorNeutralBackground1);min-height:32px;padding:0 var(--spacingHorizontalMNudge) 0 0;border-radius:var(--borderRadiusMedium);}",
...
const useInputClassName = /*#__PURE__*/ (0, _react["__resetStyles"])("r1ljrqje", null, [
    ".r1ljrqje{-ms-grid-column:1;grid-column-start:1;-ms-grid-row-span:1;grid-column-end:2;-ms-grid-row:1;grid-row-start:1;-ms-grid-row-span:1;grid-row-end:3;outline-style:none;border:0;padding:0;color:var(--colorNeutralForeground1);background-color:transparent;font-family:inherit;font-size:inherit;font-weight:inherit;line-height:inherit;width:100%;}",
