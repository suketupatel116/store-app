...
Object.defineProperty(exports, "useAvatarGroupItem_unstable", {
    enumerable: true,
    get: ()=>useAvatarGroupItem_unstable
});
...
const useAvatarGroupItem_unstable = (props, ref)=>{
    ...
    return {
        ...
        avatar: (0, _reactUtilities.resolveShorthand)(props.avatar, {
            required: true,
            defaultProps: {
                ref,
                size,
        ...
        overflowLabel: (0, _reactUtilities.resolveShorthand)(props.overflowLabel, {
            required: true,
            defaultProps: {
