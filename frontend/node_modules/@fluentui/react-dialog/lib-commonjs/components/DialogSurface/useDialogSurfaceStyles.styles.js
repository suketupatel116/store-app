...
_export(exports, {
    dialogSurfaceClassNames: ()=>dialogSurfaceClassNames,
    useDialogSurfaceStyles_unstable: ()=>useDialogSurfaceStyles_unstable
});
 ...
 */ const useStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".f1c515w{-webkit-user-select:unset;-moz-user-select:unset;-ms-user-select:unset;user-select:unset;}",
        ".f1bitti{visibility:unset;}",
        ".f15twtuk{top:0;}",
        ".f1e31b4d{right:0;}",
        ".f1vgc2s3{left:0;}",
        ".f1yab3r1{bottom:0;}",
        ...
        ".fju19wo{background-color:rgba(0, 0, 0, 0.4);}",
        ".f113wtx2{top:0px;}",
        ".f10k790i{right:0px;}",
        ".f1xynx9j{left:0px;}",
        ".f5gq2j6{bottom:0px;}",
...
const useDialogSurfaceStyles_unstable = (state)=>{
    ...
    state.root.className = (0, _react.mergeClasses)(dialogSurfaceClassNames.root, styles.root, styles.focusOutline, isNestedDialog && styles.nestedNativeDialogBackdrop, state.root.className);
    if (state.backdrop) {
