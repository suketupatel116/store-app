 ...
 */ const useStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".fn67r4l{row-gap:8px;}",
        ".f1x46k84{-ms-grid-rows:auto 1fr;grid-template-rows:auto 1fr;}",
        ".fjj47a5{-ms-grid-columns:1fr 1fr auto;grid-template-columns:1fr 1fr auto;}"
    ],
    m: [
        [
        ...
        [
            "@media screen and (max-width: 480px){.f1t97isy{-ms-grid-rows:auto 1fr auto;grid-template-rows:auto 1fr auto;}}",
            {
                m: "screen and (max-width: 480px)"
            }
        ]
