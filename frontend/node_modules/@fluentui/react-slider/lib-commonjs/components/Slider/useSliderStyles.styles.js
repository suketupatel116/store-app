 ...
 */ const useRootStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".fwk3njj{display:-ms-inline-grid;display:inline-grid;}",
        ...
        ".fgfd48t{-ms-grid-rows:1fr var(--fui-Slider__thumb--size) 1fr;grid-template-rows:1fr var(--fui-Slider__thumb--size) 1fr;}",
        ".f4t5rw1{-ms-grid-columns:1fr calc(100% - var(--fui-Slider__thumb--size)) 1fr;grid-template-columns:1fr calc(100% - var(--fui-Slider__thumb--size)) 1fr;}",
        ".f1pzv1zu{min-height:120px;}",
        ".fktlcaf{-ms-grid-rows:1fr calc(100% - var(--fui-Slider__thumb--size)) 1fr;grid-template-rows:1fr calc(100% - var(--fui-Slider__thumb--size)) 1fr;}",
        ".fiadc6h{-ms-grid-columns:1fr var(--fui-Slider__thumb--size) 1fr;grid-template-columns:1fr var(--fui-Slider__thumb--size) 1fr;}",
 ...
 */ const useInputStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".f1nzqi2z{-ms-grid-row-span:-1;grid-row-end:-1;}",
        ".fwpfdsa{-ms-grid-column:1;grid-column-start:1;}",
        ".fuur7zz{-ms-grid-column-span:-1;grid-column-end:-1;}",
