...
_export(exports, {
    drawerFooterClassNames: ()=>drawerFooterClassNames,
    useDrawerFooterStyles_unstable: ()=>useDrawerFooterStyles_unstable
});
...
const useDrawerFooterStyles_unstable = (state)=>{
    ...
    state.root.className = (0, _react.mergeClasses)(drawerFooterClassNames.root, styles.root, state.root.className);
    return state;
