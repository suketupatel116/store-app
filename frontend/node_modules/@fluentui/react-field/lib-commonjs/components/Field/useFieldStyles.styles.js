 ...
 */ const useRootStyles = /*#__PURE__*/ (0, _react["__styles"])({
    ...
    d: [
        ...
        ".f2wwaib{-ms-grid-columns:33% 1fr;grid-template-columns:33% 1fr;}",
        ".f1645dqt{-ms-grid-rows:auto auto auto 1fr;grid-template-rows:auto auto auto 1fr;}",
        ".f15jqgz8{padding-left:33%;}",
        ".fggqkej{padding-right:33%;}",
        ".f1c2z91y{-ms-grid-columns:1fr;grid-template-columns:1fr;}"
    ]
});
